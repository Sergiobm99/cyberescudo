    ...
    <div class="projects-grid">
      ...
      <a href="<?= e(BASE_URL . '/' . $item['link']) ?>" class="card"
        ...
        <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-bottom: 0.8rem;">
          ...
          <!-- Insignia del CTF -->
            <?php if ($item['link'] === 'projects/sql-injection-manual.php' || $item['link'] === 'projects/inyeccion-comandos-rfi-lfi.php' || $item['link'] === 'projects/xss-practica.php' || $item['link'] === 'projects/csrf-clickjacking.php' || $item['link'] === 'projects/xxe-path-traversal.php' || $item['link'] === 'projects/privilege-escalation-linux.php' || $item['link'] === 'projects/gobuster.php' || $item['link'] === 'projects/incident-response.php' || $item['link'] === 'projects/secure-dev.php' || $item['link'] === 'projects/nmap.php' || $item['link'] === 'projects/hydra-brute-force.php' || $item['link'] === 'projects/vuln-scanner.php' || $item['link'] === 'projects/firewall.php' || $item['link'] === 'projects/network-monitoring.php' || $item['link'] === 'projects/shodan.php' || $item['link'] === 'projects/docker-hardening.php' || $item['link'] === 'projects/nikto-dirb.php' || $item['link'] === 'projects/burpsuite.php' || $item['link'] === 'projects/john-hashcat.php' || $item['link'] === 'projects/wireshark.php' || $item['link'] === 'projects/metasploit.php' || $item['link'] === 'projects/sqlmap.php' || $item['link'] === 'projects/hardening-apache.php' || $item['link'] === 'projects/insecurebank-analisis.php'): ?>
