    ...
    <div class="projects-grid">
      ...
      <a href="<?= e(BASE_URL . '/' . $item['link']) ?>" class="card"
        ...
        <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-bottom: 0.8rem;">
            ...
            <!-- 2. Insignia del CTF (Para SQLi, Command Injection y XSS) -->
            <?php if ($item['link'] === 'projects/sql-injection-manual.php' || $item['link'] === 'projects/inyeccion-comandos-rfi-lfi.php' || $item['link'] === 'projects/xss-practica.php'): ?>
